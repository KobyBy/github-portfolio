...
// then instead of http://localhost:3000, got to http://{hostname}:3000, replacing '{hostname}' with the actual host name
                ...
                <div className="col align-self-center">
                    ...
                    {(bottomCards.length === 0 || topCards.length === 0) && (
                        <form onSubmit={handleSubmit}>
                            Enter you name to keep track of your game history
