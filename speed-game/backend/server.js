...
// Change cors to: app.use(cors({credentials: true, origin: 'http://localhost:3000'}));
// to make sessions work, also have to have `credentials: "include"` for frontend session fetches
app.use(cors());
app.use(express.json());

/* const uri = process.env.ATLAS_URI + "speed";
